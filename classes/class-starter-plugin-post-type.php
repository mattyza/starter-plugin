...
class Starter_Plugin_Post_Type {
	...
	public function get_posts ( $args = '' ) {
		...
		$args = apply_filters( 'starter_plugin_get_' . strtolower( sanitize_title_with_dashes( $this->post_type_plural ) ) . '_args', $args );
		...
		if ( '' != $tax_field_type ) {
			...
			$query_args['tax_query'] = array( array( 'taxonomy' => $this->post_type . '-category', 'field' => $tax_field_type, 'terms' => array( $term ) ) );
		}
