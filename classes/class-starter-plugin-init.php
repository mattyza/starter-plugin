...
final class Starter_Plugin {
	...
	public function __construct () {
		...
		// Admin - Start
		require_once( $this->plugin_path . '/class-starter-plugin-settings.php' );
			$this->settings = Starter_Plugin_Settings::instance();

		if ( is_admin() ) {
			require_once( $this->plugin_path . '/class-starter-plugin-admin.php' );
			$this->admin = Starter_Plugin_Admin::instance();
		}
		// Admin - End

		// Post Types - Start
		require_once( $this->plugin_path . '/class-starter-plugin-post-type.php' );
		require_once( $this->plugin_path . '/class-starter-plugin-taxonomy.php' );
